                        ...
                        <ul>
                            ...
                            <?php foreach ($exam_paper as $k => $v): ?>
                                <li <?php if ($k == 'part_1'): ?>class="cur"<?php endif; ?>>
                                    <a title="<?= $v['name']; ?>" class="chapter-switch" href="javascript:void(0);" id="<?= $k ?>"><?= $v['name']; ?> [ <?= $v['question_num']; ?>道 ]</a>
                                    <span></span>
                                </li>
                            <?php endforeach; ?>
                            <!--循环试题类型选项卡 end-->
                                        ...
                                        <div class="options">
                                            <?php if (strstr($q['correct'], "##")): ?>
                                                ...
                                                <div class="operation">
                                                    ...
                                                    <?php endif; ?>
                                                    <b></b>
                                                    <a title="收起解析" href="javascript:void(0);" class="put"><i></i>收起解析</a>
                                                </div>
                                            <?php else: ?>
                                                <p><span>正确答案是</span></p>
                                                <div class="operation">
                                ...
                                <?php foreach ($exam_paper as $k => $v): ?>
                                    <?php if (strstr($k, "part_")): ?>
                                        <?php foreach ($v['question_result'] as $v): ?>
                                            <a title="<?= $l; ?>" part-data="<?= $k ?>" question-data="question_<?= $v['id'] ?>" class="answers_a <?php if (empty($user_answer_arr[$v['id']]['info']['is_correct'])): ?>none<?php elseif ($user_answer_arr[$v['id']]['info']['is_correct'] != 1): ?>false<?php endif; ?>" href="javascript:void(0);"><?= $l; ?></a>
                                            <?php if ($l % 5 == 0): ?>
                                            </li>
                                            <li>
                                            <?php endif; ?>
