        ...
        <div class="list_box">
            ...
            <div class="right_box">
                ...
                <div class="content_box">
                    <div class="summary_1">
                        <?php if (empty($vip)): ?>
                            <p class="no_vip">加入VIP，立即享有320套精编试题（含答案与解析），每套低至5分钱——<a target="_blank" title="立即开通VIP" href="/tiku/order">立即开通VIP</a>。（立即开通VIP可点击，进入充值页面）</p>
                        <?php endif; ?>
                        <div class="left">
                        ...
                        <ul class="answer_list">
                            <li>
                                ...
                                <?php foreach ($question_arr as $q): ?>
                                    <a title="<?= $l; ?>" data="<?= $q['question_id']; ?>" class="<?php if (!empty($user_question[$q['question_id']]) && $user_question[$q['question_id']] == 1): ?>true<?php elseif (!empty($user_question[$q['question_id']]) && $user_question[$q['question_id']] == 2): ?>false<?php else: ?>none<?php endif; ?>" href="/tiku/exam_parsing/<?= $id ?>?q_id=<?= $q['question_id']; ?>"><?= $l; ?></a>
                                    <?php if ($l % 5 == 0): ?>
                                    </li>
                                    <li>
                                    <?php endif; ?>
