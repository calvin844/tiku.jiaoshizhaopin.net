            ...
            <div class="main_box do_test">
                ...
                <div class="list_box">
                    <div class="left">
                        ...
                        <ul>
                            <li class="teacher"><p>教师类型：</p><a title="幼儿" id="t0" class="teacher cur" href="javascript:void(0);">幼儿</a><a title="小学" id="t1" class="teacher" href="javascript:void(0);">小学</a><a title="中学" id="t2" class="teacher" href="javascript:void(0);">中学</a></li>
                            <?php if (!empty($exam_house_list)): ?>
                                <?php foreach ($exam_house_list as $key => $value): ?>
                                    <li class="subjects t<?= $key; ?>"><p>考试科目：</p>
                                        <?php foreach ($value as $v): ?>
                                            <a title="<?= $v['name'] ?>" data="<?= $v['id'] ?>" class="subjects" href="javascript:void(0);"><?= $v['name'] ?></a>
                                        <?php endforeach; ?>
                                    </li>
                                <?php endforeach; ?>
                            <?php endif; ?>
